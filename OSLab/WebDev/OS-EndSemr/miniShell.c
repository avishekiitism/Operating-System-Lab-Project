/*******************************************************************
 *           File:  miniShell.c
 *         Team Members:  Avishek Kumar (20JE0221)
 						  Aviral Kumar Singh (20JE0220)
 						  Gulshan Anand (20JE0382)
 						  Varun Parihar (20JE1062)
...
int shell_help(char ** args){
	printf("\nA mini implementation of the Unix Shell by (Aviral, Avishek, Gulshan, Varun) .\n");
...
void shell_loop(void){
	...
	while (status)
	{
		...
		if ( strcmp(command_line, "") == 0 ) continue;
